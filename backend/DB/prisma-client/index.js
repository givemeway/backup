...
const config = {
  generator: {
    ...
    output: {
      value:
        "C:\\Users\\Sandeep Kumar\\Desktop\\backup\\backend\\DB\\prisma-client",
      fromEnvVar: null,
    },
    config: {
      engineType: "library",
  ...
  inlineSchemaHash:
    "7f8f83d7d1cfa4ca9a164a601f6e7782f476d79c756756aff14aed3275f07050",
  copyEngine: true,
};
...
if (!fs.existsSync(path.join(__dirname, "schema.prisma"))) {
  const alternativePaths = ["DB/prisma-client", "prisma-client"];
...
path.join(
  process.cwd(),
  "DB/prisma-client/libquery_engine-debian-openssl-1.1.x.so.node"
);
...
path.join(
  process.cwd(),
  "DB/prisma-client/libquery_engine-debian-openssl-3.0.x.so.node"
);
// file annotations for bundling tools to include these files
