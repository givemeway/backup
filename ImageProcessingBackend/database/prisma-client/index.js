...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\Sandeep Kumar\\Desktop\\backup\\ImageProcessingBackend\\database\\prisma-client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "114542bb2a58fe3b086ceb73f4ac37c5eea08f3907ba070e8e51edb1b9fb3f14",
  "copyEngine": true
}
...
path.join(process.cwd(), "database/prisma-client/query_engine-windows.dll.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-1.1.x.so.node");
path.join(process.cwd(), "database/prisma-client/libquery_engine-debian-openssl-1.1.x.so.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-debian-openssl-3.0.x.so.node");
path.join(process.cwd(), "database/prisma-client/libquery_engine-debian-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "database/prisma-client/schema.prisma")
